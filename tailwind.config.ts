...
export default {
	...
	theme: {
		...
		extend: {
        fontFamily: {
          'russo': ['Russo One', 'Montserrat Alternates', 'Montserrat', 'sans-serif'],
          ...
          'inter': ['Inter', 'sans-serif'],
			...
			colors: {
				...
				'steel-grey': {
					DEFAULT: 'hsl(var(--steel-grey))',
					foreground: 'hsl(var(--steel-grey-foreground))'
				},
				'off-white': {
